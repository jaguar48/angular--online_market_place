...
export class SellerepoService {

  constructor(private http: HttpClient, private envUrl: EnvironmentUrlService) { }


  public getSellerProducts = (route: string, authToken: string) => {
    const httpOptions = {
    ...
    return this.http.get<Product[]>(this.createCompleteRoute(route, this.envUrl.urlAddress),httpOptions);
  }
